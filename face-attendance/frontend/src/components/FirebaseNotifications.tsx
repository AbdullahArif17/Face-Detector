...
export function FirebaseNotifications() {
  ...
  return (
    <div 
      className="fixed left-4 right-4 z-[9999] flex items-center justify-between rounded-xl border bg-background px-4 py-4 shadow-lg sm:bottom-4 sm:top-auto sm:left-auto sm:right-4 sm:w-auto sm:min-w-[320px] animate-in slide-in-from-bottom-4 fade-in duration-300"
