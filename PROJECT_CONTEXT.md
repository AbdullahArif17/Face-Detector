...
- WhatsApp allowlist commit `4334c72` is deployed. The corrected `/whatsapp/test` accepts local `03...` format and Meta accepted one approved test template for `923362725979`; Vercel test mode remains disabled until its two environment variables are added.
